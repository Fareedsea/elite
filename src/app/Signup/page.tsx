  ...
  return (
    <div style={{ maxWidth: '400px', margin: '0 auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" style={{ width: '100%', padding: '10px', backgroundColor: '#f90', color: '#fff', border: 'none', borderRadius: '4px' }}>
          Sign Up
        </button>
      </form>
      <div style={{ marginTop: '15px', textAlign: 'center' }}>
        <a href="#" style={{ color: '#f90' }}>Forget password?</a>
      </div>
      <div style={{ marginTop: '15px', textAlign: 'center' }}>
        <p>OR</p>
        ...
        <button style={{ width: '100%', padding: '10px', backgroundColor: '#000', color: '#fff', border: 'none', borderRadius: '4px' }}>
          Sign up with Apple
        </button>
      </div>
    </div>
