        ...
        <div className="grid lg:grid-cols-3 gap-4 max-lg:max-w-3xl mx-auto">
          <div className="lg:col-span-2 bg-white divide-y divide-gray-300 px-4">
            <div className="grid md:grid-cols-4 items-center gap-4 py-4">
              ...
              <div className="flex items-center px-3 py-1.5 gap-3 border border-gray-300 text-xs text-gray-800 rounded-full">
                <button className="font-bold text-black">
                -
                </button>
          
                <span className="font-bold text-sm leading-[18px]">0</span>
