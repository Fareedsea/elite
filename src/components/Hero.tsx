  ...
  ></div>
      ...
      <div className="relative container mx-auto flex flex-col lg:flex-row items-center justify-between py-16 px-6 md:px-12 lg:px-28">
        ...
        <div className="flex flex-col items-start lg:w-6/12 z-10">
             <span className={`${great_Vibes.className} text-2xl text-orange-500 mb-2`}> 
               Its Quick & Amusing!
            </span>
...
<div className="absolute left-11 top-1/2 transform -translate-y-1/2 flex-col items-center space-y-4 z-10 hidden md:flex">
  {/* Top White Line */}
  ...
  <div className="w-0.5 h-16 bg-white"></div>
        ...
        <div className="w-full lg:w-6/12 flex justify-center lg:justify-end mt-8 lg:mt-0 z-10 relative">
          <div className="relative">
            {/* Main Dish Image */}
            <Image
              src="/hero-01-01.png" // Path to your dish image
              alt="Delicious Dish"
              width={600}
              height={600}
