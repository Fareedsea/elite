...
<div className="font-sans divide-y rounded-lg max-w-4xl mx-auto px-4">
  ...
  <div className="accordion" role="accordion">
    ...
    <div className="content pb-6 max-h-[1000px] overflow-hidden transition-all duration-300">
      <p className="text-sm text-gray-600">
        ...
        auctor arcu, at fermentum dui. Maecenas vestibulum a turpis in lacinia.
        Proin aliquam turpis at erat venenatis malesuada. Sed semper, justo
        vitae consequat fermentum, felis diam posuere ante, sed fermentum quam
        justo in dui. Nulla facilisi. Nulla aliquam auctor purus, vitae dictum
        dolor sollicitudin vitae. Sed bibendum purus in efficitur consequat.
  ...
  <div className="accordion" role="accordion">
    ...
    <div className="content invisible max-h-0 overflow-hidden transition-all duration-300">
      <p className="text-sm text-gray-600">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor
        auctor arcu, at fermentum dui. Maecenas ongue facilisis sapien, a semper
        orci facilisis in.
      </p>
    </div>
  </div>
